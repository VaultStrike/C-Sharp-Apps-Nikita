...
{
    public class StorageHouse : StorageStructure
    {
        private double maximumWeight;
        private double maximumVolume;
        private List<IPortable> items;
        private CargoType storageType;
        public StorageHouse(CargoType driverType, string country, string city, string address, int numAddress) : base(country, city, address, numAddress)
        {
